...
- [cargo2buck2](https://github.com/mendymm/cargo2buck2) build your rust projects without needing to write your own rules
- [parakeet](https://huggingface.co/nvidia/parakeet-tdt-0.6b-v3) multilingual automatic speech recognition
- [whispypy](https://github.com/rangzen/whispypy) A signal-controlled audio transcription daemon in Python powered by locally-running OpenAI Whisper or NVIDIA Parakeet
- [CTF](https://athackctf.com/) one of the largest cyber security student hackathons in Canada.
- [Radar](https://radar.cloudflare.com/ai-insights?dateRange=12w) AI bots scan public websites to collect data used in search engines
- [Hacker spaces](https://wiki.hackerspaces.org/List_of_Hacker_Spaces) A comprehensive, user-maintained list of all active hackerspaces throughout the world.
- [Foulab](https://foulab.org/) The goal of foulab is to provide its members an environment and resources that allow them to exchange knowledge, ideas and explore new technologies. To that end, the organization will arrange a space which allows its users to collaborate.
- [Youtube](https://www.youtube.com/watch?v=x77-gT8bWLo) Problem Solve Like a Computer Programmer
